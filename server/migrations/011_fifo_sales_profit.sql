...
-- =========================================================
-- FIFO / прибыль / капитализация
-- Миграция под текущую схему BFC24 CONTROL
-- =========================================================

-- 1. sale_items: добавляем финансовые поля
...
-- 2. item_batches: updated_at для FIFO-обновлений
ALTER TABLE core.item_batches
  ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();

-- 3. Индексы для аналитики продаж
...
-- 4. CHECK на положительное qty в movements
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
