 ...
 *
 * Логика:
 * 1. Если пользователь client -> всегда его req.user.tenant_id
 * 2. Если owner -> берём req.query.tenant_id, req.body.tenant_id или req.params.tenant_id
 * 3. Для совместимости со старым режимом owner fallback -> 1
 */
